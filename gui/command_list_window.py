...
#
# Created: Sun Apr 23 18:46:36 2017
...
class Ui_command_list_window(object):
    def setupUi(self, command_list_window):
        ...
        command_list_window.setMinimumSize(QtCore.QSize(325, 359))
        command_list_window.setMaximumSize(QtCore.QSize(325, 359))
        self.wgt_command_list = QtGui.QListWidget(command_list_window)
        self.wgt_command_list.setGeometry(QtCore.QRect(10, 100, 151, 241))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.wgt_command_list.setFont(font)
        ...
        self.btn_delete_action = QtGui.QPushButton(command_list_window)
        self.btn_delete_action.setGeometry(QtCore.QRect(180, 230, 131, 31))
        self.btn_delete_action.setObjectName(_fromUtf8("btn_delete_action"))
        ...
        self.label = QtGui.QLabel(command_list_window)
    ...
    def retranslateUi(self, command_list_window):
        ...
        self.btn_delete_action.setText(_translate("command_list_window", "Delete Action", None))
        ...
        self.label.setText(_translate("command_list_window", "Type - Duration", None))
